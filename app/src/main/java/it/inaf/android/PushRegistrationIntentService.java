...
public class PushRegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            synchronized (TAG) {
                ...
                sharedPreferences.edit().putBoolean(INAF.SENT_TOKEN_TO_SERVER, true).apply();
            ...
            sharedPreferences.edit().putBoolean(INAF.SENT_TOKEN_TO_SERVER, false).apply();
        }
        // Notify UI that registration has completed, so the progress indicator can be hidden.
        Intent registrationComplete = new Intent(INAF.REGISTRATION_COMPLETE);
    ...
    private void sendRegistrationToServer(String token) {
        ...
        Log.i("general", "TOKEN IS MAYBE THE SENDERID? check the value of: " + token);
    }
